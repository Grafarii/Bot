...
async def receber_nome(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_photo(photo=imagens[0], caption="🔞 Resultados para: " + termo, reply_markup=reply_markup)
...
def buscar_imagens_rule34(termo):
    url = "https://api.rule34.xxx/index.php?page=dapi&s=post&q=index&json=1&limit=20&tags=" + termo.replace(' ', '_')
    try:
